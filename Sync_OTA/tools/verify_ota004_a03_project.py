...
lock=json.loads((root/'docs/jobs/OTA004_A03_source_lock.json').read_text(encoding='utf-8-sig'))
...
if static_only:
 print(json.dumps(dict(status='OTA004_A03_STATIC_DEPENDENCIES_PASS',**dependencies),indent=2))
 sys.exit(0)
