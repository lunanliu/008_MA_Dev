...
proc audit_project {{generated 1}} {
 ...
 puts [exec C:/Python314/python.exe -I -B -X utf8 [file join $root tools/verify_ota004_a04_project.py] $out]
}
...
if {$stage eq "prepare" && ![file exists $xpr]} {
 ...
 set ipfiles {};foreach rel [read_lines [file join $root ip/sources_a04.f]] {lappend ipfiles [file join $root $rel]}
 ...
 if {$stage eq "prepare"} {
  puts [exec C:/Python314/python.exe -I -B -X utf8 [file join $root tools/repair_ota004_a04_managed.py] $out]
 }
 open_project $xpr
}
source $hook
...
switch -- $stage {
 ...
 smoke {
  ...
  launch_simulation
  puts [exec C:/Python314/python.exe -I -B -X utf8 [file join $root tools/verify_ota004_a04_project.py] $out $simdir]
