# A06R2: exported XDC is parsed as data. No constraints are applied.
...
proc ota_a06r2_gray_audit {out} {
 ...
 puts $f "OTA004_A06R2_GRAY_EXPORT_COMPLETE groups=24";close $f
}
