...
proc audit_project {{generated 1}} {
 ...
 puts [exec C:/Python314/python.exe -I -B -X utf8 [file join $root tools/verify_ota004_a05_project.py] $out]
}
...
open_project $xpr
if {$stage eq "smoke"} {
 # Change only these two owned source members; retain all generated IP/MIF targets.
 foreach spec {{sources_1 rtl/control/sync_ota_top.sv rtl/control/sync_ota_top_a05.sv} {sim_1 sim/tb/sync_ota_smoke_tb.sv sim/tb/sync_ota_smoke_tb_a05.sv}} {
 ...
 set guard [file join $root rtl/control/ota_algorithm_reset_guard.sv]
 if {![llength [get_files -quiet $guard]]} {add_files -fileset sources_1 -norecurse $guard}
 set_property LIBRARY ota_xpm [get_files $guard]
...
switch -- $stage {
 smoke {
  ...
  launch_simulation
  puts [exec C:/Python314/python.exe -I -B -X utf8 [file join $root tools/verify_ota004_a05_project.py] $out $simdir]
  set binding [exec C:/Python314/python.exe -I -B -X utf8 [file join $root tools/verify_ota004_a05_binding.py] $simdir]
  ...
  close_sim
  puts [exec C:/Python314/python.exe -I -B -X utf8 [file join $root tools/verify_ota004_a05_sim_result.py] $simdir $out]
 }
 synth {
