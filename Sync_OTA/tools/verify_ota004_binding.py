...
assert root/'rtl/cfo/ota_cfo_chain_a02.sv' in selected_rtl
...
for name in ['sync_ota_top','sync_frontend_top','sync_sfo_top','sfo_initial_estimator','sfo_first_resampler','sfo_residual_estimator4','sfo_second_resampler','ota_cfo_chain','cfo_rotate4','cfo_coordinate_control','cfo_front2048_window','cfo_estimate74_backend','xpm_fifo_async','xpm_cdc_single','xpm_cdc_sync_rst']:
