...
rtl=lines(root/'rtl/sources.f');ips=lines(root/'ip/sources_a04.f')
...
lock=json.loads((root/'docs/jobs/OTA004_A04_source_lock.json').read_text(encoding='utf-8-sig'))
...
if static_only:
 print(json.dumps(dict(status='OTA004_A04_STATIC_DEPENDENCIES_PASS',**dependencies),indent=2))
 sys.exit(0)
