# Scoped constraints for xpm_cdc_low_latency_handshake
...
if {($src_clk != $dest_clk) || ($src_clk == "" && $dest_clk == "")} {
    ...
    common::send_msg_id "XPM_CDC_LOW_LATENCY_HANDSHAKE: TCL-1000" "WARNING" "The source and destination clocks are the same. \n     Instance: [current_instance .] \n  This will add unnecessary latency to the design. Please check the design for the following: \n 1) Manually instantiated XPM_CDC modules: Xilinx recommends that you remove these modules. \n 2) Xilinx IP that contains XPM_CDC modules: Verify the connections to the IP to determine whether you can safely ignore this message."
}

create_waiver -internal -scoped -type CDC -id {CDC-15} -user "xpm_cdc" -tags "1009444"\
-desc "The CDC-15 warning is waived as it is safe in the context of XPM_CDC_LOW_LATENCY_HANDSHAKE." \
