...
// Both clocks must run. Reset/abort assertion masks transfers immediately.
module ota_async_fifo #(
 ...
 assign wr_busy=reset_request||rw||fifo_reset||wb||!complete||!reader_ready_wr;
 assign rd_busy=reset_request||rr||rb||!reader_ready;
