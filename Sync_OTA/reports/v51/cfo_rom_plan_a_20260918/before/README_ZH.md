> **2026-09-18 routed归因与第二轮结构修改：** 已导出全部3336个失败端点、复盘129份RTL并修改9份。当前新RTL仅完成静态绑定与独立设计复核，未重新综合/实现或运行仿真，不能把旧报告当作新版本通过证据。见 [本轮交付、周期和资源报告](docs/v51/ROUTED_REDESIGN_20260918_ZH.md)。
