...
module cfo_estimator_link(
 ...
 // until the reset handshake completes. common_reset is the asynchronous mask;
 // the four-edge local reset tails flush both two-FF reset-handshake CDC paths.
 ...
 assign fast_reset_busy=common_reset||rst_fast||fifo_reset||wr_busy||!fifo_reset_done||!slow_reset_ready_fast;
 assign slow_reset_busy=common_reset||rst_slow||rd_busy||!slow_reset_ready;
 logic closed_fast;
