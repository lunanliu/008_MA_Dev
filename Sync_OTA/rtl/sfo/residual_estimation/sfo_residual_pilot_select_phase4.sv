...
module sfo_residual_pilot_select_phase4 #(
  ...
  assign select_mask[0] = slot_ok &&
      ((s_fft_beat >= 9'd1 && s_fft_beat <= 9'd205) || s_fft_beat >= 9'd307);
