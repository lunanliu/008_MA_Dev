...
module sfo_residual_pilot_front2 #(
    parameter PHASE_ROM_FILE = "residual_pilot_phase.mem"
) (
    input  logic         clk,
    input  logic         rst,
    input  logic         s_valid,
  ...
  sfo_residual_pilot_select_phase4 #(
      .PHASE_ROM_FILE(PHASE_ROM_FILE)
  ) selector (
      .clk          (clk),
      .rst          (rst),
      .s_valid      (s_valid),
      ...
      .s_fft_beat   (s_fft_beat),
      .s_tag        (s_tag),
      .m_valid      (selected_valid),
      .m_ready      (selected_ready),
      .m_data       (selected_data),
      .m_phase      (selected_phase),
      .m_mask       (selected_mask),
      .m_error      (selected_error),
      .m_symbol_slot(selected_slot),
      .m_fft_beat   (selected_beat),
      .m_tag        (selected_tag),
      .busy         (selected_busy)
  );
  sfo_residual_pilot_rotate2 rotator (
      .clk    (clk),
      .rst    (rst),
      .s_valid(selected_valid),
      .s_ready(selected_ready),
      .s_data (selected_data),
      .s_phase(selected_phase),
      .s_mask (selected_mask),
      .s_tag  (selected_tag),
      .m_valid(m_valid),
      .m_ready(m_ready),
      .m_data (m_data),
  ...
  always_ff @(posedge clk) begin
    if (rst) begin
      ...
      meta2 <= 0;
      meta3 <= 0;
    end else if (rotate_advance) begin
      meta1 <= {selected_slot, selected_beat, selected_error};
      meta2 <= meta1;
      meta3 <= meta2;
    end
  end
