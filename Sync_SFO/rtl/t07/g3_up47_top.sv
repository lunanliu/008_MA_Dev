...
module g3_up47_top #(
 parameter integer IT=4, OT=8,
 parameter integer GW=18, GS=8*((GW+7)/8)
)(
 ...
 t07_g3_up47 i_core(.aclk(aclk),.aresetn(aresetn),.s_axis_data_tvalid(s_axis_data_tvalid),.s_axis_data_tready(ri),.s_axis_data_tdata(i_in),.m_axis_data_tready(take_output),.m_axis_data_tvalid(vi),.m_axis_data_tdata(i_out));
 t07_g3_up47 q_core(.aclk(aclk),.aresetn(aresetn),.s_axis_data_tvalid(s_axis_data_tvalid),.s_axis_data_tready(rq),.s_axis_data_tdata(q_in),.m_axis_data_tready(take_output),.m_axis_data_tvalid(vq),.m_axis_data_tdata(q_out));
