...
create_project DDR_Control [file join $root project_retry05] -part xcvu11p-flgb2104-2-e
...
foreach mode {write read} {
  ...
  set_property -dict [list xsim.elaborate.xelab.more_options {-mt 16}] [get_filesets $fs]
...
set f [open [file join $root actual_sources_retry05.txt] w]
