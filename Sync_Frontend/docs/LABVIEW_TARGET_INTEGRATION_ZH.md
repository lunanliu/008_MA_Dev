> **首次导入请阅读[从选文件到读回四帧结果的逐步指南](D:/008_MA_Dev/Sync_Frontend/handoff/Sync_Frontend_20260915_manual/README_ZH.md)。** 逐页设置与端口类型以该指南为准。本文保留架构和历史技术记录；其中旧 EDF/XML 包的描述不是当前操作入口。
