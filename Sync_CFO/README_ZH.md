...
| GUI 入口 | 实际核心 top |
|---|---|
| [CFO_BACKEND74.xpr](vivado/CFO_BACKEND74/CFO_BACKEND74.xpr) | `cfo_estimate74_backend` |
| [CFO_COORD.xpr](vivado/CFO_COORD/CFO_COORD.xpr) | `cfo_coordinate_control` |
| [CFO_FFT2048.xpr](vivado/CFO_FFT2048/CFO_FFT2048.xpr) | `cfo_fft2048_core` |
| [CFO_FFT256.xpr](vivado/CFO_FFT256/CFO_FFT256.xpr) | `cfo_fft256_core` |
| [CFO_FRONT2048.xpr](vivado/CFO_FRONT2048/CFO_FRONT2048.xpr) | `cfo_front2048_window` |
| [CFO_LINK010.xpr](vivado/CFO_LINK010/CFO_LINK010.xpr) | `cfo_estimator_link` |
| [CFO_LINK010R1.xpr](vivado/CFO_LINK010R1/CFO_LINK010R1.xpr) | `cfo_estimator_link` |
| [CFO_PHASE74.xpr](vivado/CFO_PHASE74/CFO_PHASE74.xpr) | `cfo_phase74_core` |
| [CFO_SYNC.xpr](vivado/CFO_SYNC/CFO_SYNC.xpr) | `cfo_rotate4` |
