...
# Example: cfo_launch_runs {synth_1}
# Example: cfo_launch_runs {impl_1} -to_step route_design
# Resource-reviewed alternative: cfo_launch_runs {synth_1} -jobs 2
# GUI: cfo_prepare_build, then select the admitted jobs (ceiling 16) in Launch Runs.
